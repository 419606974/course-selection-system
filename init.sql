...
CREATE TABLE `achievement` (
  ...
  `gradelevel_id` int DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `achievement_ibfk_1` (`course_id`) USING BTREE,
  KEY `achievement_ibfk_2` (`student_id`) USING BTREE,
  KEY `achievement_fk_gradelevel` (`gradelevel_id`),
  CONSTRAINT `achievement_fk_gradelevel` FOREIGN KEY (`gradelevel_id`) REFERENCES `gradelevel` (`id`),
...
INSERT INTO `achievement` VALUES (1,76.00,2,8,2),(2,85.00,3,8,1),(3,85.00,2,9,1),(11,65.00,4,5,2),(12,33.00,5,5,4),(13,56.00,2,11,4),(14,88.00,2,12,1),(15,93.00,1,11,1),(16,45.00,6,1,4),(17,76.00,4,1,2),(18,96.00,1,22,1),(19,59.00,12,29,4),(20,99.00,13,29,1),(21,79.00,12,30,2),(22,59.00,10,15,4),(23,61.00,12,15,2),(25,71.50,10,30,2),(26,60.25,10,5,2),(27,72.45,14,5,2);
...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `course_number_uindex` (`number`)
...
INSERT INTO `course` VALUES (1,'ps基础','每周三晚上8:00','逸夫楼6201',30,2,'1111',1,'2023-11-01','2024-11-01','2024','1','张三','本科'),(2,'插花艺术','每周一、周三晚上8:10','德育楼1207',25,3,'2222',2,'2023-11-02','2024-11-01','2024','2','李思思','硕士'),(3,'古典文学鉴赏','每周二 、周四晚上8:10','德育楼1302',20,2,'33333',3,'2023-11-03','2024-11-01','2024','3','王珊','博士'),(4,'中国语言文学','每周2晚上8:00','信工楼2305',22,2,'44',4,'2023-11-04','2024-11-01','2024','1','陈伟','本科'),(5,'国学智慧','每周2晚上9:00','信工楼2302',28,1,'222222',3,'2023-11-05','2024-11-01','2024','2','李一樊','本科'),(6,'室内空间陈设艺术','每周一晚上8:00','艺术楼1406',15,1,'555',2,'2023-11-06','2024-11-01','2024','3','胡歌','本科'),(7,'室内设计','每周五晚上7:30','致远楼3206',10,0,'666666',1,'2023-11-07','2024-11-01','2024','1','黄磊','硕士'),(9,'影视名片鉴赏','每周1晚上8:00','多媒体教学楼1205',30,0,'777',2,'2023-11-08','2024-11-01','2024','2','宋丹丹','本科'),(10,'计算机理论','周三','逸夫楼',30,0,'88888',3,'2023-10-17','2023-11-16','2023','3','欧阳锋','本科'),(12,'数据库','周四','计算机楼',NULL,0,'1010',3,'2024-01-01','2024-05-01','2024','1','黄磊','本科'),(13,'c语言','周一','软件楼',NULL,0,'2020',4,'2024-02-01','2024-06-01','2024','2','宋丹丹','本科'),(14,'嵌入式','','',NULL,0,'453465',3,'2025-04-15','2025-04-30','2024-2025','1','胡歌','本科'),(16,'经济学概论','','',NULL,0,'99999',2,'2024-01-01','2024-05-01','2024-2025','2','黄磊','本科'),(17,'社会学概论','','',NULL,0,'888888',4,'2024-02-01','2024-06-01','2024-2025','3','宋丹丹','硕士');
...
INSERT INTO `gradelevel` VALUES (1,'1','A',80.00,100.00,4.00),(2,'2','B',60.00,79.99,3.00),(4,'3','C',40.00,59.99,2.00),(5,'4','D',0.00,39.99,0.00);
...
INSERT INTO `teacher` VALUES (1,'zhangsan','张三','12345678',1,'15825465982','zhangsan@qq.com','教授','我是教师1号',NULL,'111112','博士'),(14,'lisi','李思思','12345678',0,'15828556459','lisi@qq.com','讲师','22222222222222',NULL,'22222','本科'),(15,'wangshan','王珊','11112222',0,'13564585956','wangshan@163.com','副教授','高级教师',NULL,'5555','研究生'),(16,'chenwei','陈伟','12345678',1,'13526589569','chenwei@qq.com','教授','高级教师，中共党员，校骨干教师，近几年分别取得市“教坛新秀”、“教学能手”称号，刚聘为校教研员。',NULL,'3542','博士'),(17,'liyifan','李一樊','11223344',1,'15854658957','liyifan@qq.com','讲师','多次获市级教学成绩奖;连续两届被评为“教学能手”、“先进教育工作者”;多次执教市区级公开课和示范课。',NULL,'86452','本科'),(19,'huge','胡歌','huge',1,'13066669876','13066669876@qq.com','教授','',NULL,'33333','研究生'),(20,'huanglei','黄磊','huanglei',1,'19187658888','huanglei@qq.com','教授','',NULL,'7777','博士'),(21,'songdandan','宋丹丹','songdandan',0,'18377773456','songdandan@163.com','副教授','',NULL,'8888','本科'),(22,'9999','欧阳锋','9999',1,'13649585621','ouyangfeng@qq.com','教授','',NULL,'9999','研究生');
...
INSERT INTO `user` VALUES (1,'20240101','李龙','12345678','lilong@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','我是一个学生哈',1,NULL,1,'广州','2024-10-30','1','专业一','团契一','13111112222'),(2,'20240102','张一','12345678','user111111@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','嘿嘿嘿1111',1,NULL,1,'惠州','2024-10-29','2','艺术','团契一','18322225555'),(5,'20240103','陈凡','test2','test2@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','33333333333',1,NULL,0,'佛山','2024-10-14','3','专业222','团契一','13355559999'),(7,'20240506','吴用','123456','test1@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','11111111111111',0,NULL,1,'佛山','2024-10-27','1','专业2','团契一','15644443333'),(8,'20040603','李刚','12345678','aa@tongtech.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,1,NULL,1,'珠海','2024-10-15','2','专业一','团契一','18133336666'),(9,'20230501','陈烨','adfasdfasdfafd','bb@163.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,1,NULL,1,'肇庆','2024-10-23','3','专业2','团契二','19155557777'),(10,'20210406','殷撤','cccccccc','cc@163.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','22223234adfasdf',1,NULL,0,'清远','2024-10-14','1','专业2','团契3','13355554444'),(11,'20200509','胡美','ddddd','dddd@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,0,NULL,0,'江门','2024-10-04','2','专业2','团契3','12266669999'),(12,'20190801','王胡','asdfasdfasdfasdf','aasdfasdf@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','adsafasdfasdfasdfa',1,NULL,1,'深圳','2024-10-05','1','艺术','团契3','15566667777'),(13,'20241203','张三丰','adsadsfadsfadfadfa','adsfafa@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44','25454545787822',0,NULL,1,'广州','2024-10-12','2','专业一','团契3','18899995555'),(14,'20240708','贾秀秀','rrrrr','rrrrr@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,1,NULL,0,'香港','2024-10-26','1','艺术','团契二','13266664444'),(15,'20180516','陈胜','asdfasdfadfasdf','1234444@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,1,NULL,1,'澳门','2024-10-17','2','艺术','团契二','15644449999'),(20,'20240109',NULL,'d8W2lt1G','chenrui@qq.com',3,'2024-11-04 14:27:44','2024-11-04 14:27:44',NULL,1,NULL,0,'汕头','2024-10-21','1','数学','团契3','13155552222'),(22,'123456','侯亮平','123456','5544982@qq.com',3,'2024-10-31 15:14:02',NULL,'',1,NULL,1,'湖南','2024-09-01','类别一','园艺','团契 10','13066665555'),(29,'156894','小鱼儿','156894','xiaoyuuer@qq.com',3,'2024-10-31 19:26:00',NULL,'',1,NULL,0,'河北','2024-01-01','类别1','计算机','团契一','15066887744'),(30,'124956','花无缺','124956','huawuque@qq.com',3,'2024-10-31 19:26:00',NULL,'',1,NULL,1,'河南','2024-05-06','类别9','软件','团契四','19155223344');
...
-- Dump completed on 2025-04-16 14:48:47
